...
public class ArchitectureAnalyzer : DiagnosticAnalyzer
{
    ...
    static readonly DiagnosticDescriptor Rule0001 = CreateRule("CRARCH0001", "Exception type naming", "Exception type '{0}' must not end with 'Exception'");
    static readonly DiagnosticDescriptor Rule0002 = CreateRule("CRARCH0002", "No built-in exception types", "Throw custom domain exceptions instead of '{0}'");
    static readonly DiagnosticDescriptor Rule0003 = CreateRule("CRARCH0003", "No postfixes on class names", "Class '{0}' must not end with postfix '{1}'");
    static readonly DiagnosticDescriptor Rule0004 = CreateRule("CRARCH0004", "No .Features. in namespace", "Namespace '{0}' must not contain '.Features.'");
    static readonly DiagnosticDescriptor Rule0005 = CreateRule("CRARCH0005", "No regions", "Avoid #region directives");
    static readonly DiagnosticDescriptor Rule0006 = CreateRule("CRARCH0006", "Logging via LoggerMessage", "Use [LoggerMessage] generated methods instead of direct ILogger.Log* calls");
    static readonly DiagnosticDescriptor Rule0007 = CreateRule("CRARCH0007", "No IServiceProvider injection", "Do not inject IServiceProvider; inject specific interfaces");
    static readonly DiagnosticDescriptor Rule0008 = CreateRule("CRARCH0008", "Use is null checks", "Use 'is null'/'is not null' instead of '== null'/'!= null'");
    static readonly DiagnosticDescriptor Rule0009 = CreateRule("CRARCH0009", "Use string interpolation", "Use string interpolation instead of string.Format or concatenation");
    static readonly DiagnosticDescriptor Rule0010 = CreateRule("CRARCH0010", "Constructor fan-out", "Constructor has {0} dependencies (maximum is 7)");
    static readonly DiagnosticDescriptor Rule0011 = CreateRule("CRARCH0011", "File length threshold", "File has {0} effective lines (maximum is 400)");
    static readonly DiagnosticDescriptor Rule0012 = CreateRule("CRARCH0012", "async void forbidden", "Avoid async void methods outside event handlers", DiagnosticSeverity.Error);
    static readonly DiagnosticDescriptor Rule0013 = CreateRule("CRARCH0013", "No blocking on async", "Avoid blocking async calls via .Result, .Wait(), or .GetAwaiter().GetResult()");
    static readonly DiagnosticDescriptor Rule0014 = CreateRule("CRARCH0014", "No test types in production", "Production code must not reference testing/specification types: '{0}'", DiagnosticSeverity.Error);
    static readonly DiagnosticDescriptor Rule0015 = CreateRule("CRARCH0015", "Static class naming convention", "Static class '{0}' must end with one of: {1}");
    static readonly DiagnosticDescriptor Rule0016 = CreateRule("CRARCH0016", "Unused interfaces", "Interface '{0}' has no concrete implementations");
    static readonly DiagnosticDescriptor Rule0017 = CreateRule("CRARCH0017", "Namespace must align with folder path", "Namespace '{0}' should align with folder path '{1}'");
    static readonly DiagnosticDescriptor Rule0018 = CreateRule("CRARCH0018", "Avoid concrete type injection", "Constructor dependency '{0}' should be an interface abstraction");
    ...
    static DiagnosticDescriptor CreateRule(string id, string title, string messageFormat, DiagnosticSeverity severity = DiagnosticSeverity.Warning)
        => new(id, title, messageFormat, "Architecture", severity, isEnabledByDefault: true);
