...
public class and_constructor_has_more_than_seven_dependencies : given.a_constructorfanoutrule
{
    async Task Because() =>
...
{
    public Sample(
        int dep1, int dep2, int dep3, int dep4,
        int dep5, int dep6, int dep7, int dep8) { }
}
""");
